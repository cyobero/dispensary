...
def product_info_view(request, slug):
    ...
    return render(request, 'product_info_view.html', {'flower': flower})


def shop_home_view(request):
    return render(request, 'shop_home_view.html')
...
def flowers_home_view(request):
    ...
    return render(request, 'flowers_home_view.html', {'flowers_list': flowers_list})
...
def growers_home_view(request):
    ...
    return render(request, 'growers_home_view.html',
...
def grower_info_view(request, slug):
    ...
    return render(request, 'grower_info_view.html', {'grower': grower})
